...
class TestIntcode(unittest.TestCase):
    ...
    def test_case_1(self):
        ...
        Machina = part_1.Computer(my_input)
        Machina.set_input(8)
    ...
    def test_case_4(self):
        my_input = get_input('input3')
        Machina = part_1.Computer(my_input)
        Machina.process_code_sequence()
        print("<---------------------------Case 4------------------------------------>")

    def test_case_5(self):
        my_input = get_input('input4')
        Machina = part_1.Computer(my_input)
        self.assertEqual(1219070632396864, Machina.process_code_sequence())
        print("<---------------------------Case 5------------------------------------->")

    def test_case_6(self):
        my_input = get_input('input5')
        Machina = part_1.Computer(my_input)
        self.assertEqual(1125899906842624,Machina.process_code_sequence())
        print("<---------------------------Case 6------------------------------------>")
    '''
    def test_case_7(self):
#        my_input = get_input('input')
        my_input = get_custom_input()
        Machina = part_1.Computer(my_input)
        Machina.set_input(2)
        Machina.process_code_sequence()
        print("<--------------------------Case 7------------------------------------->")
